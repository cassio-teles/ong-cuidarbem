...
`;function h(e){let o=e.value.replace(/\D/g,"").slice(0,11);o=o.replace(/^(\d{3})(\d)/,"$1.$2"),o=o.replace(/^(\d{3})\.(\d{3})(\d)/,"$1.$2.$3"),o=o.replace(/(\d{3})\.(\d{3})\.(\d{3})(\d{1,2})$/,"$1.$2.$3-$4"),e.value=o}function y(e){let o=e.value.replace(/\D/g,"").slice(0,11);o=o.replace(/^(\d{2})(\d)/,"($1) $2"),o.length<=13?o=o.replace(/(\d{4})(\d)/,"$1-$2"):o=o.replace(/(\d{5})(\d)/,"$1-$2"),e.value=o}function E(e){let o=e.value.replace(/\D/g,"").slice(0,8);o=o.replace(/^(\d{5})(\d)/,"$1-$2"),e.value=o}function q(){const e=document.getElementById("cpf"),o=document.getElementById("telefone"),t=document.getElementById("cep");e&&e.addEventListener("input",()=>h(e)),o&&o.addEventListener("input",()=>y(o)),t&&t.addEventListener("input",()=>E(t))}function L(e){const o=e.replace(/\D/g,"");if(o.length!==11||/^(\d)\1{10}$/.test(o))return!1;let t=0,r;for(let a=1;a<=9;a++)t+=parseInt(o.substring(a-1,a))*(11-a);if(r=t*10%11,(r===10||r===11)&&(r=0),r!==parseInt(o.substring(9,10)))return!1;t=0;for(let a=1;a<=10;a++)t+=parseInt(o.substring(a-1,a))*(12-a);return r=t*10%11,(r===10||r===11)&&(r=0),r===parseInt(o.substring(10,11))}function C(e,o){e.classList.add("invalid");const t=document.getElementById(`${e.id}-error`);t&&(t.textContent=o,t.style.display="block")}function u(e){e.classList.remove("invalid");const o=document.getElementById(`${e.id}-error`);o&&(o.textContent="",o.style.display="none")}function d(e){let o=!0,t="";return e.hasAttribute("required")&&(e.type==="checkbox"&&!e.checked?(o=!1,t="Você deve aceitar os termos."):e.value.trim()===""&&(o=!1,t="Este campo é obrigatório.")),o&&e.hasAttribute("minlength")&&e.value.length<parseInt(e.minLength,10)&&(o=!1,t=`Este campo deve ter no mínimo ${e.minLength} caracteres.`),o&&e.type==="email"&&e.value.trim()!==""&&(/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e.value)||(o=!1,t="Por favor, insira um e-mail válido.")),o&&e.hasAttribute("pattern")&&e.value.trim()!==""&&(new RegExp(e.pattern).test(e.value)||(o=!1,t="O formato está incorreto. Siga o exemplo.")),o&&e.id==="cpf"&&e.value.trim()!==""&&(L(e.value)||(o=!1,t="Este CPF não é válido. Verifique os dígitos.")),o?u(e):C(e,t),o}function $(e){const o=document.getElementById(e);if(!o)return;const t=o.querySelectorAll("input[required], select[required], textarea[required]");t.forEach(r=>{r.addEventListener("blur",()=>{d(r)}),r.addEventListener("input",()=>{r.classList.contains("invalid")&&u(r)})}),o.addEventListener("submit",function(r){r.preventDefault();let a=!0;if(t.forEach(i=>{d(i)||(a=!1)}),a){const i=new FormData(o),s={};i.forEach((l,n)=>{Object.prototype.hasOwnProperty.call(s,n)?(Array.isArray(s[n])||(s[n]=[s[n]]),s[n].push(l)):s[n]=l}),localStorage.setItem("cadastroVoluntario",JSON.stringify(s)),console.log("Dados salvos no localStorage:",s),alert('Cadastro salvo com sucesso! (Verifique o console ou a aba "Application" do navegador)'),o.reset()}else{const i=o.querySelector(".invalid");if(i){i.focus();const s=i.previousElementSibling,l=s?s.textContent:"O primeiro campo inválido";console.warn(`Erro de validação no campo: ${l}`)}}})}const c={"/":v,"/projetos":g,"/cadastro":b,"/404":()=>'<section class="container card mt-16"><h2>Página não encontrada (404)</h2><p>O conteúdo que você procura não foi localizado.</p></section>'};function P(){const e=window.location.hash;return e===""||e==="#"?"/":e.slice(1)}function p(){const e=document.getElementById("app-root");if(!e){console.error("ERRO: Elemento #app-root não foi encontrado.");return}const o=P(),t=c[o]||c["/404"];e.innerHTML=t(),o==="/cadastro"&&(q(),$("cadForm")),window.scrollTo(0,0)}function A(){window.addEventListener("hashchange",p),window.location.hash||(window.location.hash="#/"),p()}function S(){const e=document.getElementById("hamburgerBtn"),o=document.getElementById("mobileMenu");!e||!o||(e.addEventListener("click",()=>{o.classList.toggle("open"),e.classList.toggle("active")}),o.addEventListener("click",t=>{t.target.tagName==="A"&&(o.classList.remove("open"),e.classList.remove("active"))}))}function O(){const e=document.getElementById("themeToggleBtn");if(!e)return;function o(i){i?(document.body.classList.add("dark-mode"),e.innerHTML="🌙",e.setAttribute("aria-label","Mudar para tema claro"),e.setAttribute("title","Mudar para tema claro")):(document.body.classList.remove("dark-mode"),e.innerHTML="☀️",e.setAttribute("aria-label","Mudar para tema escuro"),e.setAttribute("title","Mudar para tema escuro"))}const t=localStorage.getItem("theme"),r=window.matchMedia("(prefers-color-scheme: dark)").matches;let a=t==="dark"||t===null&&r;o(a),e.addEventListener("click",()=>{a=!document.body.classList.contains("dark-mode"),o(a),localStorage.setItem("theme",a?"dark":"light")})}function w(){S(),O(),A()}document.addEventListener("DOMContentLoaded",w);
